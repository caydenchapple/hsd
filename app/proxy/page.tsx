      ...
      <div className="flex justify-center">
        ...
        <div className="flex-1 w-full pt-[60px] md:pt-0 md:ml-[72px] xl:ml-[245px] min-h-screen transition-all duration-300">
           <div className="flex flex-col h-full w-full">
             ...
             {/* Browser Bar */}
             <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-40 shadow-sm flex items-center space-x-2">
                <button onClick={handleBack} className="p-2 hover:bg-gray-100 rounded-full" title="Back">
                    <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <form onSubmit={handleBrowse} className="flex-1 flex items-center bg-gray-100 rounded-lg px-4 py-2 focus-within:ring-1 focus-within:ring-gray-300">
